        ...
        >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    ...
                    <p className="text-sm/7 mt-6">AI Resume Analyzer helps you optimize your resume for ATS and land your dream job with AI-powered insights.</p>
                </div>
                <div className="flex flex-col lg:items-center lg:justify-center">
                    <div className="flex flex-col text-sm space-y-2.5">
                        <h2 className="font-semibold mb-5 text-white">Company</h2>
                        <a className="hover:text-slate-500 transition" href="#">About us</a>
                        <a className="hover:text-slate-500 transition" href="#">Careers<span className="text-xs text-black bg-primary rounded-md ml-2 px-2 py-1">We’re hiring!</span></a>
                ...
                <div>
                    ...
                    <div className="text-sm space-y-6 max-w-sm">
                        ...
                        <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-secondary">
                            ...
                            <button className="bg-primary px-4 py-2 text-black rounded">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
            <p className="py-4 text-center border-t mt-6 border-slate-700">
                Copyright 2025 © <a href="/">AI Resume Analyzer</a> All Right Reserved.
            </p>
        </motion.footer>
    );
};